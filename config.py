...
available_setting = {
    # openai api配置
    "open_ai_api_key": "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",  # openai api key
    # openai apibase，当use_azure_chatgpt为true时，需要设置对应的api base
    "open_ai_api_base": "https://api.openai.com/v1",
    "proxy": "http://127.0.0.1:10810",  # openai使用的代理
    ...
    "group_name_white_list": ['ALL_GROUP'], # '["ChatGPT测试群", "ChatGPT测试群2"],  # 开启自动回复的群名称列表
    "group_name_keyword_white_list": [],  # 开启自动回复的群名称关键词列表
    "group_chat_in_one_session": ["ALL_GROUP"],# ["ChatGPT测试群"],  # 支持会话上下文共享的群名称
